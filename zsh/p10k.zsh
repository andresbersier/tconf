# Generated by Powerlevel10k configuration wizard on 2019-09-24 at 16:01 BST.
...
() {
  ...
  # *42 if have stashes.
  vcs+='${${VCS_STATUS_STASHES:#0}:+ %76Fs${VCS_STATUS_STASHES}}'
  ...
  # Icon color.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_COLOR=122
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_VCS_CLEAN_FOREGROUND=48
  typeset -g POWERLEVEL9K_VCS_UNTRACKED_FOREGROUND=48
  ...
  typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=156
  # Default context format: %n is username, %m is hostname.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%B%n@%m:'

  # Context color when running with privileges.
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_FOREGROUND=205
  ...
  ####################################[ time: current time ]####################################
  # Current time color.
  typeset -g POWERLEVEL9K_TIME_FOREGROUND=87
